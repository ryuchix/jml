...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Document Types<small><?php echo $record->id? 'edit': 'new'; ?></small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo site_url( $class_name ); ?>"><i class="fa fa-user"></i> Document Type</a></li>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group <?php echo form_error('data[type]')? 'has-error':''; ?>">
                                ...
                                <input type="text" class="form-control" name="data[type]" id="type" placeholder="Document type" value="<?php echo set_value('data[type]', $record->type); ?>">
