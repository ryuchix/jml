...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url( $context ); ?>"><i class="fa fa-user"></i> Property</a></li>
            <li><a href="<?php echo site_url( "gallery/$context/$context_id" ); ?>"><i class="fa fa-user"></i> Gallery</a></li>
    ...
    <section class="content ">
        ...
        <!-- form start -->
        <form role="form" method="post" action="<?php echo site_url( "gallery/gallery_description/$record->id" ); ?>">
            <div class="row grid">
