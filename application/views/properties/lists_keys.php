...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url( "property/keys/$property_id/lists" ); ?>"><i class="fa fa-file-o"></i> Keys</a></li>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane <?php echo $inactive_list; ?>" id="tab_1-1">
                                    ...
                                    <?php $this->load->view('properties/keys_table', array('records'=>$inactive_records)); ?>
