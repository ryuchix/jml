...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url( "property/gallery/$property_id/lists" ); ?>"><i class="fa fa-file-o"></i> Gallery</a></li>
                    ...
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs pull-right">
                              ...
                              <li class="<?php echo $active_list; ?>"><a href="#tab_2-2" data-toggle="tab" aria-expanded="false"></a></li>
                              <li class="pull-left header"><a href="<?php echo site_url( "property/gallery/$property_id/save" ); ?>" style="display: inline;"><i class="fa fa-plus"></i></a> Property Gallery</li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane <?php echo $inactive_list; ?>" id="tab_1-1">

                                    <?php $this->load->view('properties/gallery_table', array('records'=>$inactive_records)); ?>
                                    
                                </div><!-- /.tab-pane -->
                                
                                <div class="tab-pane <?php echo $active_list; ?>" id="tab_2-2">

                                    <?php $this->load->view('properties/gallery_table', array('records'=>$records)); ?>
