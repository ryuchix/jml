...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1><?php echo ucfirst($class_name) ?> History <small></small></h1>
    
        <ol class="breadcrumb">
    
            <li><a href="<?php echo site_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
    
            <li><a href="<?php echo site_url( $class_name ); ?>"><i class="fa fa-life-ring"></i> Properties</a></li>
    
            <li><a href="<?php echo site_url( $class_name ); ?>"><i class="fa fa-lists-ul"></i> List</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-default <?php echo form_error('description')? '':'collapsed-box'; ?>">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo site_url( $class_name.'/history/'.$property_id ); ?>" method="POST">
