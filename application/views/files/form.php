...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>File <small><?php echo $record->id? 'edit': 'new'; ?></small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo site_url( 'files/' ); ?>"><i class="fa fa-user"></i> Files</a></li>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <!-- form start -->
            <form role="form" method="post" action="<?php echo site_url( "files/save/".$record->id ); ?>">
                <div class="col-sm-8">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                value="file-<?php echo $record->id? $record->id: $expected_memo_number; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="data[type]" id="type" class="form-control">
                                    <option value="memo" <?php echo $record->type == 'memo'? 'selected':'' ?>>Memo</option>
                                    <option value="staff file" <?php echo $record->type == 'staff file'? 'selected':'' ?>>Staff File</option>
                                    <option value="tutorial" <?php echo $record->type == 'tutorial'? 'selected':'' ?>>Tutorial</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="UPLOAD_URL" value="<?php echo site_url( 'files/upload_complain_file/'.$record->id ); ?>">
                                <input type="hidden" id="DELETE_URL" value="<?php echo site_url( 'files/delete_via_ajax/' ); ?>">
