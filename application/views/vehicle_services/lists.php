...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>Vehicle Services <small>list</small></h1>
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url( "vehicle_servies/lists/$vehicle_id" ); ?>"><i class="fa fa-fax"></i> Vehicle Services</a></li>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_2-2">
                                    ...
                                    <?php $this->load->view('vehicle_services/table', array('records'=>$records)); ?>
