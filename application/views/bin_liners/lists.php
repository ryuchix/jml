...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>Bin Liner <small>list</small></h1>
                    ...
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <ul class="nav nav-tabs pull-right">
                              ...
                              <li class="pull-left header"><a href="<?php echo site_url( $class_name."/settings" ); ?>" style="display: inline;"><i class="fa fa-plus"></i></a> <?php echo $class_title ?> List</li>
                            </ul>
