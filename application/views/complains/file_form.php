...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url( 'complaints/files/'.$complain_id ); ?>"><i class="fa fa-user"></i> Files</a></li>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <!-- form start -->
            <form role="form" method="post" action="<?php echo site_url( "complaints/files/$complain_id/save/".$record->id ); ?>">
                <div class="col-sm-8">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="UPLOAD_URL" value="<?php echo site_url( 'complaints/upload_complain_file/'.$record->id ); ?>">
                                <input type="hidden" id="DELETE_URL" value="<?php echo site_url( 'complaints/delete_via_ajax/' ); ?>">
                                <input type="hidden" id="RECORD_ID" value="<?php echo $record->id; ?>">
                                <input type="hidden" id="FOLDER" value="complain_files">
                                <input type="hidden" id="MODEL" value="Complain_file">
                                <div class="progress">
