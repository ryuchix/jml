...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>Issues/Complaints History <small></small></h1>
    
        <ol class="breadcrumb">
    
            <li><a href="<?php echo site_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
    
            <li><a href="<?php echo site_url( 'complaints/' ); ?>"><i class="fa fa-life-ring"></i> Issue / Complaints</a></li>
    
            <li><a href="<?php echo site_url( 'complaints/' ); ?>"><i class="fa fa-lists-ul"></i> List</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-default <?php echo form_error('description')? '':'collapsed-box'; ?>">
                ...
                <div class="box-body">
                    ...
                    <form action="<?php echo site_url( 'complaints/history/'.$complain_id ); ?>" method="POST">
