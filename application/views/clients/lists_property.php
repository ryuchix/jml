...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1><?php echo ucwords($class_name); ?> <small>Property list</small></h1>
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs pull-right">
                                ...
                                <li class="pull-left header">
                                    <a href="<?php echo site_url( "property/save?client=$client_id" ); ?>" style="display: inline;">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                    <?php echo (isset($_GET['client']))? $_GET['client']."'s ":''; ?> Property List
                                </li>
                            </ul>
