...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <!-- form start -->
            <form role="form" method="post" action="<?php echo site_url( "client/contact/".$record->id."/edit/" ); ?>">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group <?php echo form_error('data[surname]')? 'has-error':''; ?>">
                                ...
                                <input type="text" class="form-control" name="data[surname]" id="surname" placeholder="Contact name" value="<?php echo set_value('data[surname]', $record->surname); ?>">
                                <?php echo form_error('data[surname]','<p class="error-msg">','</p>') ?>
                            </div>

                            <div class="form-group <?php echo form_error('data[role]')? 'has-error':''; ?>">
                                <label for="role">Role</label>
                                <input type="tel" class="form-control" name="data[role]" id="role" placeholder="Role" value="<?php echo set_value('data[role]', $record->role); ?>">
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" name="data[is_primary]" <?php echo $record->is_primary?'checked':'' ?>>Primary
                                    </label>
                                </div>
                            </div>
