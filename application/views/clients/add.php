                ...
                <div class="col-sm-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                          <h3 class="box-title"><?php echo $record->id? 'Edit':'Add new'; ?> Client</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="form-group <?php echo form_error('data[name]')? 'has-error':''; ?>">
                                <label for="name">Client Name</label>
                                <input type="text" class="form-control" name="data[name]" id="name" placeholder="Client Name" value="<?php echo set_value('data[name]'); ?>">
                            ...
                            <div class="form-group <?php echo form_error('data[client_type]')? 'has-error':''; ?>">
                                ...
                                <?php echo form_dropdown('data[client_type]', $client_types, isset($_POST['data']['client_type'])?$_POST['data']['client_type']:'', 'class="client_type form-control" id="id_label_single"'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="data[website]" id="website" placeholder="Website" value="<?php echo set_value('data[website]'); ?>">
                            </div>

                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" name="data[is_parent]" checked>Is parent?
                                    </label>
                                </div>
                            </div>

                            <div class="isnt-parent-condition" style="display: none;">
                                <div class="form-group <?php echo form_error('data[child_of]')? 'has-error':''; ?>">
                                    <label for="child_of">Select Parent:</label>
                                    <?php echo form_dropdown('data[child_of]', $parent_clients, isset($_POST['data']['child_of'])?$_POST['data']['child_of']:'', 'class="is_parent_choose form-control" id="child_of"'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control" name="data[address_1]" id="address_1" placeholder="Address" value="<?php echo set_value('data[address_1]'); ?>">
                            </div>

                            <div class="form-group">
                                <label for="address_state">State:</label>
                                <input type="text" class="form-control" name="data[address_state]" readonly id="address_state" placeholder="State" value="<?php echo set_value('data[address_state]'); ?>">
                            </div>

                            <div class="form-group">
                                <label for="address_suburb">Suburb:</label>
                                <input type="text" class="form-control" name="data[address_suburb]" readonly id="address_suburb" placeholder="Suburb" value="<?php echo set_value('data[address_suburb]'); ?>">
                            </div>

                            <div class="form-group">
                                <label for="address_post_code">Postcode:</label>
                                <input type="text" class="form-control" name="data[address_post_code]" readonly id="address_post_code" placeholder="Post Code" value="<?php echo set_value('data[address_post_code]'); ?>">
                            </div>

                            <input type="hidden" name="data[address_location]" id="address_location" value="<?php echo set_value('data[address_location]'); ?>">
                            <input type="hidden" name="data[address_long_state]" id="address_long_state" value="<?php echo set_value('data[address_long_state]'); ?>">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group <?php echo form_error('data[attention]')? 'has-error':''; ?>">
                                ...
                                <input type="text" class="form-control" name="data[attention]" id="attention" placeholder="Attention" value="<?php echo set_value('data[attention]'); ?>">
                                <?php echo form_error('data[attention]','<p class="error-msg">','</p>') ?>
                            </div>

                            <div class="form-group">
                                <label for="co">C/O</label>
                                <input type="text" class="form-control" name="data[co]" id="co" placeholder="C/O" value="<?php echo set_value('data[co]'); ?>">
                            </div>
                            ...
                            <div id="different_billing" <?php echo 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="data[billing_address_street]" id="billing_address_street" placeholder="Search Address" value="<?php echo set_value('data[billing_address_street]'); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="billing_address_1">Address:</label>
                                    <input type="text" readonly class="form-control" name="data[billing_address_1]" id="billing_address_1" placeholder="Address" value="<?php echo set_value('data[billing_address_1]'); ?>">
                                </div>

                                <div class="form-group <?php echo form_error('data[billing_state]')? 'has-error':''; ?>">
                                    <label for="billing_state">State:</label>
                                    <input type="text" class="form-control" name="data[billing_state]" readonly id="billing_state" placeholder="State" value="<?php echo set_value('data[billing_state]'); ?>">
                                ...
                                <div class="form-group <?php echo form_error('data[billing_suburb]')? 'has-error':''; ?>">
                                    ...
                                    <input type="text" class="form-control" name="data[billing_suburb]" readonly id="billing_suburb" placeholder="Suburb" value="<?php echo set_value('data[billing_suburb]'); ?>">
                                ...
                                <div class="form-group <?php echo form_error('data[billing_post_code]')? 'has-error':''; ?>">
                                    ...
                                    <input type="text" class="form-control" name="data[billing_post_code]" readonly id="billing_post_code" placeholder="Post Code" value="<?php echo set_value('data[billing_post_code]'); ?>">
