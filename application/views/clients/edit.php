                        ...
                        <div class="box-body">
                            ...
                            <div id="different_billing" <?php echo 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" name="data[billing_address_1]" id="billing_address_1" placeholder="Address" value="<?php echo set_value('data[billing_address_1]', $record->billing_address_1); ?>">
                                </div>

                                <div class="form-group <?php echo form_error('data[billing_state]')? 'has-error':''; ?>">
                                    <label for="billing_state">State:</label>
                                    <input type="text" class="form-control" name="data[billing_state]" readonly id="billing_state" placeholder="State" value="<?php echo set_value('data[billing_state]', $record->billing_state); ?>">
                                ...
                                <div class="form-group <?php echo form_error('data[billing_suburb]')? 'has-error':''; ?>">
                                    ...
                                    <input type="text" class="form-control" name="data[billing_suburb]" readonly id="billing_suburb" placeholder="State" value="<?php echo set_value('data[billing_suburb]', $record->billing_suburb); ?>">
                                ...
                                <div class="form-group <?php echo form_error('data[billing_post_code]')? 'has-error':''; ?>">
                                    ...
                                    <input type="text" class="form-control" name="data[billing_post_code]" readonly id="billing_post_code" placeholder="State" value="<?php echo set_value('data[billing_post_code]', $record->billing_post_code); ?>">
...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBa0XPDzdP8ATw5PZPiv7Fm7DKm5gW_ko8&libraries=places&callback=initMap" -->
        async defer></script>
<script>
