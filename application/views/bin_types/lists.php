...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>Bin Types <small>list</small></h1>
    
        <ol class="breadcrumb">
    
            <li><a href="<?php echo site_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
    
            <li><a href="<?php echo site_url( 'bin_type/' ); ?>"><i class="fa fa-trash"></i> Bin Types</a></li>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane <?php echo $inactive_list; ?>" id="tab_1-1">
                                    ...
                                    <?php $this->load->view('bin_types/table', array('records'=>$inactive_records)); ?>
                                    
                                </div><!-- /.tab-pane -->
                                
                                <div class="tab-pane <?php echo $active_list; ?>" id="tab_2-2">

                                    <?php $this->load->view('bin_types/table', array('records'=>$records)); ?>
