...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>Vehicle <small>list</small></h1>
    
        <ol class="breadcrumb">
    
            <li><a href="<?php echo site_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
    
            <li><a href="<?php echo site_url( $class_name ); ?>"><i class="fa fa-trash"></i> Vehicles</a></li>
                    ...
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <ul class="nav nav-tabs pull-right">
                              <li class="<?php echo $inactive_list; ?>"><a href="#tab_1-1" data-toggle="tab" aria-expanded="true">Inactive <?php echo $class_title ?>s</a></li>
                              <li class="<?php echo $active_list; ?>"><a href="#tab_2-2" data-toggle="tab" aria-expanded="false">Active <?php echo $class_title ?>s</a></li>
