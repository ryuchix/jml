...
<div class="content-wrapper" id="scheduleBinLiner">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url( 'schedule/bin-cleaning' ); ?>"><i class="fa fa-user"></i> Costing</a></li>
        </ol>
    </section>
    <br>
    <!-- Main content -->
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="client_type">Services:</label>
                                        <select v-model="form.services" id="client_type" class="form-control" multiple size=8>
                                            <option v-for="service in services" :value="service.id">{{ service.type }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
    ...
    var app = new Vue({
        ...
        methods: {
            init()
            {
                ...
                axios.get("<?php echo site_url('job_categories/get_job_category_json'); ?>").then((data) => {
            ...
            report(){
                this.jobs = [];
                this.isLoading = true;
                axios.post("<?php echo site_url('schedules/costing-filter'); ?>", this.form).then((data) => {
